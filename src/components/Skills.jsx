...
const Skills = () => {
  return (
    <div className="w-[80%] flex flex-wrap items-center justify-center" id="skills">
      ...
      <div className="w-full  flex flex-wrap justify-center items-center">
        {SkillsInfo.map((data) => (
          <div
            ...
            className="border rounded-2xl lg:rounded-3xl   border-purple-500 flex flex-col flex-wrap w-full h-full lg:w-[40%] lg:h-96 mt-3 lg:m-6"
          >
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 w-full h-[80%] gap-3 justify-center items-center lg:p-5 p-3 ">
              {data.skills.map((daata) => (
                ...
                >
                  ...
                  />
                  <h1 className="h-fit w-full lg:w-[70%] text-center">{daata.name}</h1>
                </div>
              ))}
            </div>
            </Tilt>
